...
CREATE INDEX `idx_wishlist_pledge_user` ON `wishlist_pledge` (`user_id`);--> statement-breakpoint
CREATE INDEX `idx_wishlist_pledge_token` ON `wishlist_pledge` (`confirm_token_hash`);