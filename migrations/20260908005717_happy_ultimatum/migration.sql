...
--> statement-breakpoint
ALTER TABLE `reservation` ADD `lock_synced_at` integer;--> statement-breakpoint
ALTER TABLE `reservation` ADD `lock_fallback_revealed_at` integer;--> statement-breakpoint
CREATE INDEX `idx_lock_fallback_active` ON `lock_fallback_code` (`retired_at`,`synced_at`);--> statement-breakpoint
