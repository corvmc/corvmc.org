...
| [packing-list-spec.md](specs/packing-list-spec.md)                 | 🔧     | spec      | What goes in the van, who is bringing it, and whether it is loaded — the tech rider asked the friendlier way round. Two owner columns that are not redundant, a diff-not-replace save, and a conditional claim. **Phase 1 shipped**; 2 and 3 on `feature/band-packing-list` |
