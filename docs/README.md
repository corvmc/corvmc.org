...
| [formal-balloting-spec.md](specs/formal-balloting-spec.md)             | 📋     | spec      | Group ballots (committee roster, recorded) and member-wide ballots (members of record, secret but auditable: participation and a per-option counter, no joinable link). Tallies hidden until close; a named certifier publishes the result (#577) |
