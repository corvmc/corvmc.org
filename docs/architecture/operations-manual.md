...
| `0 16 * * *`   | `/api/cron/generate-recurring-reservations`, `/api/cron/lock-access`, `/api/cron/cancel-stale-tickets`, `/api/cron/sweep-audio-purchases`, `/api/cron/sweep-incidents`, `/api/cron/sweep-media`                           | daily, 8am PST / 9am PDT    |
