...
const sample: Record<EntityType, { title: string; subtitle?: string; [k: string]: unknown }> = {
	...
	equipment: { title: 'Fender Twin Reverb', subtitle: 'Amplifiers · 4 units' },
	asset: { title: 'CMC-000123', subtitle: 'Fender Twin Reverb · Good condition' },
	...
	incident: { title: 'Cable run across the side-stage steps', subtitle: 'Safety hazard' }
};
