<script lang="ts">
	...
	import { RemoveCategoryAction } from '$lib/components/shared/actions';
	import { addCategory, editCategory, getEquipmentCategories } from '$lib/remote/equipment.remote';
	 ...
	 *
	 * It owns `getEquipmentCategories` rather than taking the list as a prop, so `/staff/equipment`
